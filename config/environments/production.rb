Aquakids::Application.configure do
  ...
  config.assets.precompile += %w( schedules.js autoclasses.js classes.js bootstrap.js parentspaymentsdue.js payment_plan_instalments.js)
