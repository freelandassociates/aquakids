class SchedulesController < ApplicationController
  ...
  def update
    ...
    params[:schedule][:start_time] = DateTime.zone.parse(params[:schedule][:start_time]).to_time
    params[:schedule][:stop_time] = DateTime.zone.parse(params[:schedule][:stop_time]).to_time
